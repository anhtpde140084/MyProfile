    ...
    <body>
        <div class="main-container">
            ...
            <div class="sidebar">
                ...
                <ul class="nav">
                    <li id="home"><a href="${pageContext.request.contextPath}/home"><i class="fa fa-home"></i><span id="c">Home</span></a></li>
                    <li id="about"><a href="${pageContext.request.contextPath}/about"><i class="fa fa-user"></i>About</a></li>
                    <li id="weblog"><a href="${pageContext.request.contextPath}/show-blogs"><i class="fa fa-envelope"></i>Weblog</a></li>
                    <li id="contactus"><a href="${pageContext.request.contextPath}/views/contact.jsp"><i class="fa fa-phone"></i>Contact</a></li>
                </ul>
            </div>
            <!--End Of Side Bar-->
